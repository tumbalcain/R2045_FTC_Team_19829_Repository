...
@Config
@Autonomous(name="R2045_DECODE_Autonomous_RED_UP", group="R2045_DECODE")
public class R2045_DECODE_Autonomous_RED_UP extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d beginPose = new Pose2d(46.21, 57.17, Math.toRadians(-137));
        ...
        Action pathSPOne = drive.actionBuilder(beginPose)
                .splineTo(new Vector2d(-0.26, 10.66), Math.toRadians(-137)) // Spawn to LZ
                .build();
        // end of pathSPOne
        ...
        Action pathSPFour = drive.actionBuilder(lz)
                ...
                .splineTo(new Vector2d(50.08, -36.31), Math.toRadians(0.00)) // Spike Mark 1 AIS
